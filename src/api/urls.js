var url = 'http://ornaments.panel.jewelmarts.in/webservices/';

export const urls = {
  baseUrl: 'http://ornaments.panel.jewelmarts.in/webservices/',

  imageUrl: 'http://ornaments.panel.jewelmarts.in/',
