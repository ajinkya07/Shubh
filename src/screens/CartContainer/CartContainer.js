...
class CartContainer extends Component {
  constructor(props) {
    ...
    const from =
      ...
      this.props.route.params.fromProductGrid;
      ...
      <TouchableOpacity onPress={() => this.setToggleView(data)}>
        <View style={styles.tabCartTopContainer}>
          ...
          <View style={styles.chainTitleView}>
            <Text style={styles.chainTitleText}>{data.design_number}</Text>
    ...
    return (
      <TouchableOpacity onPress={() => this.setCartToggleView(item)}>
        <View style={styles.tabCartTopContainer}>
          ...
          <View style={styles.chainTitleView}>
            <Text style={styles.chainTitleText}>{item.design_number}</Text>
  ...
  render() {
    ...
    const cartSummary =
      cartSummaryData &&
      cartSummaryData.cart_summary &&
      cartSummaryData.cart_summary.product_master;
    const cartWeight =
      cartWeightData && cartWeightData.data && cartWeightData.data.cart_data;

    const totalWT =
      cartWeightData && cartWeightData.data && cartWeightData.data.total_weight;
...
function mapStateToProps(state) {
  return {
    ...
    successCartSummaryVersion:
      state.cartContainerReducer.successCartSummaryVersion,
    ...
    successCartWeightVersion:
      state.cartContainerReducer.successCartWeightVersion,
